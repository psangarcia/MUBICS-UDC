...
if sum(H_kt)==0 %si cumple la condicion de normalidad
    ...
    %Sino cumple la condicion de normalidad se ejecuta el test
    %kruskalwallis
else
...
% Cuanto mas a la dereca mas precision, en el diagrama de rayas. En gris
% salen todos aquellos que serian similares al mejor modelo. Los que queden
% fuera de ese rango (rojos) son los que si hay diferenencias
% significativas y podemos decir que son peores. 